...
namespace tai_shop.Migrations
{
    ...
    [Migration("20250210211010_complaints")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tai_shop.Models.CustomerComplaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("tai_shop.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("tai_shop.Models.Payment", b =>
                {
                    b.HasOne("tai_shop.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("tai_shop.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
